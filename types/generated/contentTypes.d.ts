...
export interface ApiUrunKategoriUrunKategori
  ...
  attributes: {
    ...
    >;
    urunKategoriName: Schema.Attribute.Text;
    urunKategoriSlideImage: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
...
export interface ApiUrunlerUrunler extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    urun_kategori: Schema.Attribute.Relation<
      'manyToOne',
      'api::urun-kategori.urun-kategori'
    >;
    urunDesc: Schema.Attribute.RichText;
    urunImage: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    urunName: Schema.Attribute.Text;
  };
}
